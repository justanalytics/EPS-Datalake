CREATE TABLE  epsdlsrip.rej_sri_account
(
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_account' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrip.rej_sri_account_mapping
(
 `oracle_natural_account` string,
 `ledger_card` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_account_mapping' TBLPROPERTIES ('transactional'='false'); 


CREATE TABLE  epsdlsrip.rej_sri_reporting_lines
(
 `oracle_natural_account` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_reporting_lines' TBLPROPERTIES ('transactional'='false');


CREATE TABLE   epsdlsrip.rej_sri_company_hierarchy
(
 `child_value` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_company_hierarchy' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrip.rej_sri_company_master
(
 `child_value` string,
 `danaos_co_code` string,
 `database` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_company_master' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrip.rej_sri_vessel_hierarchy
(
 `vessel_code` string,
 `vessel_name` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_vessel_hierarchy' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrip.rej_sri_vessel_master
(
 `vessel_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_vessel_master' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrip.rej_sri_service_hierarchy
(
 `service_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_service_hierarchy' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_documents 
( 
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_documents' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_requisitions 
( 
`vessel_code` string,
`department` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_requisitions' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_expected_call_da
(
`vessel_code` string,
`exp_ref` timestamp,
`agent_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_expected_call_da' TBLPROPERTIES ('transactional'='false');


create table epsdlsrip.rej_sri_vessel_dry_dock_details
(   
`vessel_code` string,
`project_id` double,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_vessel_dry_dock_details' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_budget_opex_monitor 
( 
`vessel_code` string, 
`vessel_name` string, 
`ledger_card` string, 
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_budget_opex_monitor' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_supply_items 
( 
`document_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_supply_items' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_item_ledgers 
(
`ledger_card` string,
`department` string,
`catalogue` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_item_ledgers' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_del_departments 
( 
`name` string,
`code` string,
`form_type` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_del_departments' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_order_details 
( 
`document_code` string,
`document_date` timestamp,
`order_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_order_details' TBLPROPERTIES ('transactional'='false');


create table epsdlsrip.rej_sri_dept_mapping
(  
`type` string,
`dept_code` string,   
`acc_code` string,  
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_dept_mapping' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_vessel_team_map
(
`company` string,
`type` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_vessel_team_map' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_department 
( 
`child_value` string, 
`description` string, 
`department` string, 
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_department' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrip.rej_sri_data_security 
( 
`user_email` string, 
`dimension` string, 
`level` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltaprod/epsdlsrip/rej_sri_data_security' TBLPROPERTIES ('transactional'='false');