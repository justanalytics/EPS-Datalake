...
CREATE TABLE epsdlsrid.sri_imos_port_call
(
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_imos_port_call' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.sri_imos_expected_call
(
`agreed_speed` decimal(38,18),
`agreed_speed_cons` decimal(38,18),
`agreed_speed_engine_load` decimal(38,18),
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_imos_expected_call' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.sri_expected_call
(
`vessel_code` string,
`eta` timestamp,
`port_name` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_expected_call' TBLPROPERTIES ('transactional'='false');


create table  epsdlsrid.sri_ports_library
(
`port_name` string,
`port_country` string,
`bp_code` string,
...
`w_location`,
`w_batch_id`
)  location '/mnt/epsdldeltadev/epsdlsrid/sri_ports_library' tblproperties ('transactional'='false');


create table  epsdlsrid.sri_bp_ports
(
`port_code` string,
`port_name` string,
`port_country` string,
...
`w_location`,
`w_batch_id`
)  location '/mnt/epsdldeltadev/epsdlsrid/sri_bp_ports' tblproperties ('transactional'='false');



CREATE TABLE  epsdlsrid.sri_telegrams
(
`vessel_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_telegrams' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.sri_telegrams_custom
(
`vessel_code` string,
`telegram_date` timestamp,
`telegram_type` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_telegrams_custom' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.sri_companies
(
`child_value` string,
`description` string,
`le` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_companies' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.sri_intercompany
(
 `ledger_code` string,
 `name` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/sri_intercompany' TBLPROPERTIES ('transactional'='false');