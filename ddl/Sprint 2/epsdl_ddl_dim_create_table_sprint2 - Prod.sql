CREATE TABLE epsdlp.dim_reqn_audit
(
`audit_id` double,
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_reqn_audit' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlp.dim_supplier
(
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_supplier' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlp.dim_department
(
`name` string,
`code` string,
`form_type` string,
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_department' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlp.dim_requisitions
(
`vessel_code` string,
`department` string,
`document_code` string,
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_requisitions' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlp.dim_requisitions_category
(
`req_id` int,
`req_desc` string,
`document_code` string,
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_requisitions_category' TBLPROPERTIES ('transactional'='false');


-- drop table epsdlp.dim_gl_company;
...
CREATE EXTERNAL TABLE `epsdlp`.`dim_gl_future1`
(`future1_id` BIGINT, 
`future1_code` STRING, 
`future1_name` STRING
) 
using delta
LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_gl_future1' TBLPROPERTIES ('transactional'='false');


CREATE TABLE `epsdlp`.`dim_gl_future2`
(`future2_id` BIGINT, 
`future2_code` STRING, 
`future2_name` STRING
) 
using delta
LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_gl_future2' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlp.dim_gl_intercompany
(
 `ledger_code` string,
 `name` string,
...
PARTITIONED BY  (
`business_date`
) LOCATION '/mnt/epsdldeltaprod/epsdlp/dim_gl_intercompany' TBLPROPERTIES ('transactional'='false');

alter table epsdlp.dim_gl_vessel add columns (supplier_flag int, port_calls_flag int);
alter table epsdlsrip.sri_vessel_master add columns(supplier_flag int, port_calls_flag int);