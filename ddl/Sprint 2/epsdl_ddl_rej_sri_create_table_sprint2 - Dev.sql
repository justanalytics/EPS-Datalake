CREATE TABLE epsdlsrid.rej_sri_supplier_invoicing
(
`invoice_no` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_supplier_invoicing' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrid.rej_sri_reqn_audit_log
(
`audit_id` double,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_reqn_audit_log' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrid.rej_sri_supplier_registry
(
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_supplier_registry' TBLPROPERTIES ('transactional'='false');


CREATE TABLE epsdlsrid.rej_sri_delivery_point
(
`id` decimal(38,18),
`vessel_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_delivery_point' TBLPROPERTIES ('transactional'='false');

---Agnit

CREATE TABLE epsdlsrid.rej_sri_imos_port_call
(
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_imos_port_call' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.rej_sri_imos_expected_call
(
`agreed_speed` decimal(38,18),
`agreed_speed_cons` decimal(38,18),
`agreed_speed_engine_load` decimal(38,18),
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_imos_expected_call' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.rej_sri_expected_call
(
`vessel_code` string,
`eta` timestamp,
`port_name` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_expected_call' TBLPROPERTIES ('transactional'='false');


create table  epsdlsrid.rej_sri_ports_library
(
`port_name` string,
`port_country` string,
`bp_code` string,
...
`w_location`,
`w_batch_id`
)  location '/mnt/epsdldeltadev/epsdlsrid/rej_sri_ports_library' tblproperties ('transactional'='false');


create table  epsdlsrid.rej_sri_bp_ports
(
`port_code` string,
`port_name` string,
`port_country` string,
...
`w_location`,
`w_batch_id`
)  location '/mnt/epsdldeltadev/epsdlsrid/rej_sri_bp_ports' tblproperties ('transactional'='false');



CREATE TABLE  epsdlsrid.rej_sri_telegrams
(
`vessel_code` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_telegrams' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.rej_sri_telegrams_custom
(
`vessel_code` string,
`telegram_date` timestamp,
`telegram_type` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_telegrams_custom' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.rej_sri_companies
(
`child_value` string,
`description` string,
`le` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_companies' TBLPROPERTIES ('transactional'='false');


CREATE TABLE  epsdlsrid.rej_sri_intercompany
(
 `ledger_code` string,
 `name` string,
...
`w_location`,
`w_batch_id`
)  LOCATION '/mnt/epsdldeltadev/epsdlsrid/rej_sri_intercompany' TBLPROPERTIES ('transactional'='false');